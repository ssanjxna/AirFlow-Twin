...
def run_simulation():
    ...
    log_user_action(user_id, "RUN_SIMULATION", "User triggered delay simulation")
    ...
    cursor.execute("""
        ...
        VALUES (?, ?, ?, ?, ?)
    """, (flight_id, predicted_delay, risk_score, risk_level, reason))
    ...
    cursor.execute("""
        ...
        VALUES (?, ?, ?, ?)
    """, (flight_id, action, priority, "pending"))
    ...
    cursor.execute("""
        ...
        VALUES (?, ?, ?)
    """, (flight_id, "Simulation completed", "success"))
