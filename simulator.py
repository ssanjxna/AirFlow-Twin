    ...
    flights = [
        {
            "label": "LOW",
            "data": make_flight(
                flight_id=f"SIM{suffix}01",
                flight_number=f"EK{suffix}1",
                airline="Emirates",
                origin="Dubai",
                aircraft_type="B777",
                risk_scenario="LOW",
        ...
        },
        {
            "label": "MEDIUM",
            "data": make_flight(
                flight_id=f"SIM{suffix}02",
                flight_number=f"TK{suffix}2",
        ...
        },
        {
            "label": "HIGH",
            "data": make_flight(
                flight_id=f"SIM{suffix}03",
                flight_number=f"SA{suffix}3",
        ...
        },
        {
            "label": "CRITICAL",
            "data": make_flight(
                flight_id=f"SIM{suffix}04",
                flight_number=f"QR{suffix}4",
